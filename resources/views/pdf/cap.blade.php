 ...
 ">
    ...
    margin-bottom: 0px; border-bottom: 1px solid black; width:fit-content;" >Telefon No: </div>
     ...
     ">
        ...
        <div style="
        margin-bottom: 0px; border-bottom: 1px solid black; width:fit-content;">Anadal Fakültesi:</div> <br>
        <div style="
        margin-bottom: 0px; border-bottom: 1px solid black; width:fit-content;">Anadal Bölümü: </div><br>
        <div style="
