...
<body>
  <div style="  position: absolute;
    ...
    <div style="font-weight: normal; text-align:center; font-size:20px;">Yatay Geçiş Başvurusu </div>
 ...
 ">
    ...
    <div style="
    margin-bottom: 0px; border-bottom: 1px solid black; width:fit-content;">Uyuruk: TC</div><br>
